...
namespace argos 
{
...
#ifdef ARGOS_WITH_LUA
   void CCI_NewEPuckProximitySensor::ReadingsToLuaState(lua_State* pt_lua_state) {
   ...
   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_NewEPuckProximitySensor::SReading& s_reading) {
   ...
   std::ostream& operator<<(std::ostream& c_os,
                            const CCI_NewEPuckProximitySensor::TReadings& t_readings) {
      if(! t_readings.empty()) {
