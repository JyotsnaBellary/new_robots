/**
 * @file <argos3/plugins/robots/newepuck/simulator/newepuck_base_ground_rotzonly_sensor.cpp>
 *
...
#include "newepuck_base_ground_rotzonly_sensor.h"
using namespace std;
namespace argos {
   ...
   CNewEPuckBaseGroundRotZOnlySensor::CNewEPuckBaseGroundRotZOnlySensor() :
   ...
   void CNewEPuckBaseGroundRotZOnlySensor::SetRobot(CComposableEntity& c_entity) {
   ...
   void CNewEPuckBaseGroundRotZOnlySensor::Init(TConfigurationNode& t_tree) {
      try {
         CCI_NewEPuckBaseGroundSensor::Init(t_tree);
         /* Parse noise level */
   ...
   void CNewEPuckBaseGroundRotZOnlySensor::Update() {
   ...
   void CNewEPuckBaseGroundRotZOnlySensor::Reset() {
   ...
   REGISTER_SENSOR(CNewEPuckBaseGroundRotZOnlySensor,
                   "newepuck_ground", "rot_z_only",
                   "Carlo Pinciroli [ilpincy@gmail.com]",
                   "1.0",
                   "The new_e-puck base ground sensor.",
                   "This sensor accesses the new_e-puck base ground sensor. For a complete description\n"
                   "of its usage, refer to the ci_newepuck_base_ground_sensor.h interface. For the XML\n"
