...
#ifndef NEWEPUCK_LIDAR_SENSOR_H
#define NEWEPUCK_LIDAR_SENSOR_H

namespace argos
{
    class CNewEPuckLidarSensor;
}
...
namespace argos
{
    ...
    class CNewEPuckLidarSensor : public CSimulatedSensor,
                            public CCI_NewEPuckLidarSensor
    {

    public:
        CNewEPuckLidarSensor();

        virtual ~CNewEPuckLidarSensor() {}
