/**
 * @file <newepuck/simulator/qtopengl_newepuck.h>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#ifndef QTOPENGL_NEWEPUCK_H
#define QTOPENGL_NEWEPUCK_H

namespace argos {
   class CQTOpenGLNewEPuck;
...
namespace argos {
   ...
   public:
      ...
      virtual ~CQTOpenGLNewEPuck();

      virtual void Draw(CNewEPuckEntity& c_entity);
