/**
 * @file <testbot/simulator/testbot_entity.h>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#ifndef TESTBOT_ENTITY_H
#define TESTBOT_ENTITY_H
...
namespace argos {
   ...
   class CTestBotEntity : public CComposableEntity {
   ...
   public:
      ...
      CTestBotEntity(const std::string& str_id,
