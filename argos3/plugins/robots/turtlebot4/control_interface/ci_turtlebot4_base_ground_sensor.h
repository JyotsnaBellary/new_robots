/**
 * @file <argos3/plugins/robots/turtlebot4/control_interface/ci_turtlebot4_base_ground_sensor.h>
 *
 * @brief This file provides the interface of the turtlebot4 base ground sensor.
 *
