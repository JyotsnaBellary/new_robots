#include "ci_turtlebot4_colored_blob_omnidirectional_camera_sensor.h"
...
namespace argos
{
   ...
   /****************************************/
      ...
      {
         /* Perform action */
         CLuaUtility::GetDeviceInstance<CCI_Turtlebot4ColoredBlobOmnidirectionalCameraSensor>(pt_lua_state, "turtlebot4_colored_blob_omnidirectional_camera")->Enable();
         return 0;
      }
   #endif
      ...
      {
         /* Perform action */
         CLuaUtility::GetDeviceInstance<CCI_Turtlebot4ColoredBlobOmnidirectionalCameraSensor>(pt_lua_state, "turtlebot4_colored_blob_omnidirectional_camera")->Disable();
         return 0;
      }
   #endif
   ...
   #ifdef ARGOS_WITH_LUA
      void CCI_Turtlebot4ColoredBlobOmnidirectionalCameraSensor::CreateLuaState(lua_State *pt_lua_state)
      {
         CLuaUtility::OpenRobotStateTable(pt_lua_state, "turtlebot4_colored_blob_omnidirectional_camera");
   ...
   #ifdef ARGOS_WITH_LUA
      void CCI_Turtlebot4ColoredBlobOmnidirectionalCameraSensor::ReadingsToLuaState(lua_State *pt_lua_state)
      {
         lua_getfield(pt_lua_state, -1, "turtlebot4_colored_blob_omnidirectional_camera");
         ...
         {
            /* Set to nil all the extra entries */
