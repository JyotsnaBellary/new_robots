#ifndef CCI_TURTLEBOT4_COLORED_BLOB_OMNIDIRECTIONAL_CAMERA_SENSOR_H
#define CCI_TURTLEBOT4_COLORED_BLOB_OMNIDIRECTIONAL_CAMERA_SENSOR_H

namespace argos {
   class CCI_Turtlebot4ColoredBlobOmnidirectionalCameraSensor;
}
...
namespace argos {
    ...
    */
   class CCI_Turtlebot4ColoredBlobOmnidirectionalCameraSensor: public CCI_Sensor {
   ...
   public:
       ...
       * polar coordinates. The angle is counted counter-clockwise watching the Turtlebot4 from top, as to respect the
   ...
   public:
       ...
       * Constructor
       */
      CCI_Turtlebot4ColoredBlobOmnidirectionalCameraSensor() {}

      /**
       * Destructor
       */
      virtual ~CCI_Turtlebot4ColoredBlobOmnidirectionalCameraSensor() {}
