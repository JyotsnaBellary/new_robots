...
namespace argos {
   class CDynamics3DTurtlebot4Model;
...
namespace argos {
   ...
   class CDynamics3DTurtlebot4Model : public CDynamics3DMultiBodyObjectModel {

   public:     

      CDynamics3DTurtlebot4Model(CDynamics3DEngine& c_engine,
                            CTurtlebot4Entity& c_turtlebot4);

      virtual ~CDynamics3DTurtlebot4Model() {}
