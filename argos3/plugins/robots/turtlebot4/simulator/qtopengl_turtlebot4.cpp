...
//       const GLfloat pfColor[]     = { 1.0f, 0.41f, 0.71f, 1.0f }; // Hot pink (RGB)
//    const GLfloat pfSpecular[]  = { 0.9f, 0.9f, 0.9f, 1.0f };  // Shiny highlights
//    const GLfloat pfShininess[] = { 100.0f };                  // Glossy surface
//    const GLfloat pfEmission[]  = { 0.1f, 0.0f, 0.1f, 1.0f };  // Slight glow tint
...
//    void CQTOpenGLTurtlebot4::SetCircuitBoardMaterial() {
