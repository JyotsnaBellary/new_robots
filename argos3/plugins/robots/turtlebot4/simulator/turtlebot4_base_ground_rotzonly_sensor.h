...
namespace argos {
   class CTurtlebot4BaseGroundRotZOnlySensor;
...
namespace argos {
   ...
   class CTurtlebot4BaseGroundRotZOnlySensor : public CCI_Turtlebot4BaseGroundSensor,
                                            public CSimulatedSensor {
      
   public:

      CTurtlebot4BaseGroundRotZOnlySensor();

      virtual ~CTurtlebot4BaseGroundRotZOnlySensor() {}
