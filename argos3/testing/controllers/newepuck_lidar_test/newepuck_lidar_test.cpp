...
CNewEPuckLidarTest::CNewEPuckLidarTest() :
   m_pcWheels(NULL),
   m_pcLidar(NULL),
...
void CNewEPuckLidarTest::Init(TConfigurationNode& t_node) {
   /*
...
void CNewEPuckLidarTest::LogLightReadings() const {
 ...
 */
REGISTER_CONTROLLER(CNewEPuckLidarTest, "newepuck_lidar_test_controller")
