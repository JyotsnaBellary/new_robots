/**
 * @file <newepuck/simulator/dynamics3d_newepuck_model.h>
 *
 * @author Michael Allwright - <allsey87@gmail.com>
 */

#ifndef DYNAMICS3D_NEWEPUCK_MODEL_H
#define DYNAMICS3D_NEWEPUCK_MODEL_H

namespace argos {
   class CDynamics3DNewEPuckModel;
...
namespace argos {
   ...
   class CDynamics3DNewEPuckModel : public CDynamics3DMultiBodyObjectModel {

   public:     

      CDynamics3DNewEPuckModel(CDynamics3DEngine& c_engine,
                            CNewEPuckEntity& c_newepuck);

      virtual ~CDynamics3DNewEPuckModel() {}
