/**
 * @file <newepuck/simulator/qtopengl_newepuck.cpp>
 *
 * @author Carlo Pinciroli - <ilpincy@gmail.com>
 */

#include "qtopengl_newepuck.h"
...
namespace argos {
   ...
   CQTOpenGLNewEPuck::CQTOpenGLNewEPuck() :
      m_unVertices(40),
   ...
   void CQTOpenGLNewEPuck::Draw(CNewEPuckEntity& c_entity) {
      /* Place the chassis */
   ...
   void CQTOpenGLNewEPuck::SetGreenPlasticMaterial() {
   ...
   void CQTOpenGLNewEPuck::SetRedPlasticMaterial() {
   ...
   void CQTOpenGLNewEPuck::SetCircuitBoardMaterial() {
   ...
   void CQTOpenGLNewEPuck::SetLEDMaterial(GLfloat f_red,
                                       GLfloat f_green,
                                       GLfloat f_blue) {
   ...
   void CQTOpenGLNewEPuck::RenderWheel() {
      /* Set material */
   ...
   void CQTOpenGLNewEPuck::RenderChassis() {
      /* Set material */
   ...
   void CQTOpenGLNewEPuck::RenderBody() {
      /* Set material */
      SetGreenPlasticMaterial();
   ...
   void CQTOpenGLNewEPuck::RenderLED() {
      /* Side surface */
      CVector2 cVertex(BODY_RADIUS, 0.0f);
      CRadians cAngle(CRadians::TWO_PI / m_unVertices);
      CVector2 cNormal(1.0f, 0.0f);
   ...
   class CQTOpenGLOperationDrawNewEPuckNormal : public CQTOpenGLOperationDrawNormal {
   public:
      void ApplyTo(CQTOpenGLWidget& c_visualization,
                   CNewEPuckEntity& c_entity) {
         static CQTOpenGLNewEPuck m_cModel;
   ...
   class CQTOpenGLOperationDrawNewEPuckSelected : public CQTOpenGLOperationDrawSelected {
   public:
      void ApplyTo(CQTOpenGLWidget& c_visualization,
                   CNewEPuckEntity& c_entity) {
   ...
   REGISTER_QTOPENGL_ENTITY_OPERATION(CQTOpenGLOperationDrawNormal, CQTOpenGLOperationDrawNewEPuckNormal, CNewEPuckEntity);

   REGISTER_QTOPENGL_ENTITY_OPERATION(CQTOpenGLOperationDrawSelected, CQTOpenGLOperationDrawNewEPuckSelected, CNewEPuckEntity);
